...
parser.add_argument("--image_height", type=int, default=512, help="scale images to this size before cropping to 256x256")
parser.add_argument("--image_width", type=int, default=512, help="scale images to this size before cropping to 256x256")
