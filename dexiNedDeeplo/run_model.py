...
class run_DexiNed():
    ...
    def train(self):
        ...
        my_model = DexiNedTj(rgb_mean=self.args.rgbn_mean)#rgb_mean=self.args.rgbn_mean
        ...
        my_model.summary()
        plot_model(my_model, show_shapes=True, to_file='modelDEXIII.png')
    ...
    def test(self):
        ...
        my_model = DexiNedTj(rgb_mean=self.args.rgbn_mean)
